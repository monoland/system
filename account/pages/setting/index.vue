                    ...
                    <v-row>
                        ...
                        <v-col cols="12">
                            <v-select
                                ...
                                hide-details
                                @update:modelValue="updateTheme($event, store)"
                            ></v-select>
                        </v-col>
                ...
                <v-card-text>
                    ...
                    >
                        ...
                        <p class="mt-3 text-justify">
                            ...
                            Anda akan di minta untuk scan kode QR dan meng-input
                            token keamanan. Anda akan mendapatkan token ini
                            melalui aplikasi Google Authenticator di handphone.
                        </p>
                    </div>
                    ...
                    >
                        <p class="text-justify">
                            Silahkan scan QR code di bawah menggunakan aplikasi
                            Google Authenticator di handphone Anda.
                        </p>
                    ...
                    >
                        <p>
                            Fitur otentifikasi dua langkah sekarang telah aktif.
                        </p>
            ...
            >
                ...
                <v-card-text>
                    <div class="text-grey-darken-1 mb-4">
                        ...
                        <p class="mt-3">
                            list dibawah ini adalah beberapa sesi terbaru Anda.
                            Daftar ini mungkin tidak lengkap, jika Anda merasa
                            bahwa akun Anda telah disusupi. Anda juga harus
